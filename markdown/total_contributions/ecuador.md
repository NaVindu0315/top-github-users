...
The `public contributions` and `private contributions` by users in Ecuador on `2024/1/24 5:14 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
