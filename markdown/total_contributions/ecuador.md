...
The `public contributions` and `private contributions` by users in Ecuador on `2024/2/16 5:13 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
