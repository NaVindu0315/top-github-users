...
The `public contributions` and `private contributions` by users in Venezuela on `2024/2/20 3:14 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
