...
The `public contributions` and `private contributions` by users in Colombia on `2024/1/24 9:15 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
