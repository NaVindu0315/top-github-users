...
The `public contributions` and `private contributions` by users in Mali on `2024/1/14 5:08 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
