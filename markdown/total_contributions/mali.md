...
The `public contributions` and `private contributions` by users in Mali on `2024/3/23 9:07 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.
