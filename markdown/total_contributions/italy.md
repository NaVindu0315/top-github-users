...
The `public contributions` and `private contributions` by users in Italy on `2024/4/9 12:21 PM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.
