...
The `public contributions` and `private contributions` by users in Taiwan on `2024/4/8 6:18 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.
