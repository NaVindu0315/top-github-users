...
The `public contributions` and `private contributions` by users in Egypt on `2024/3/28 4:15 AM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
