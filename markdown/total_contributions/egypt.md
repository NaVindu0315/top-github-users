...
The `public contributions` and `private contributions` by users in Egypt on `2024/4/2 10:14 PM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
