...
The `public contributions` and `private contributions` by users in Norway on `2024/2/13 4:16 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.
