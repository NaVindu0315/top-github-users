...
The `public contributions` by users in Finland on `2024/2/5 10:16 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
