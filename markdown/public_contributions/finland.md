...
The `public contributions` by users in Finland on `2024/1/19 4:17 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
