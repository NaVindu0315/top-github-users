...
The `public contributions` by users in Finland on `2024/2/16 10:14 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
