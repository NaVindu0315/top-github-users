...
The `public contributions` by users in Kenya on `2024/4/9 5:15 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
