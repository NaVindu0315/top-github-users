...
The `public contributions` by users in Jordan on `2024/2/11 11:13 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
