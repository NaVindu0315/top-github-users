...
The `public contributions` by users in Jordan on `2024/1/14 5:14 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
