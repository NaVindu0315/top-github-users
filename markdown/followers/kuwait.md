...
The `number of followers` of users in Kuwait on `2024/2/17 8:12 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
