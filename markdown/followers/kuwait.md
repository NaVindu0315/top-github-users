...
The `number of followers` of users in Kuwait on `2024/4/9 6:14 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
