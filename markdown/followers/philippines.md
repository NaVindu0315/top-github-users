...
The `number of followers` of users in Philippines on `2024/1/27 5:14 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
