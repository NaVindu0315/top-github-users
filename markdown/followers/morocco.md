...
The `number of followers` of users in Morocco on `2024/2/12 7:14 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
