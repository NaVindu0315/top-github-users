...
The `number of followers` of users in Colombia on `2024/3/16 7:14 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
