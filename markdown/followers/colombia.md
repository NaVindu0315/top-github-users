...
The `number of followers` of users in Colombia on `2024/1/18 3:15 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
