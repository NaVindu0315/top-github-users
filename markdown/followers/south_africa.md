...
The `number of followers` of users in South Africa on `2024/2/14 2:21 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
