...
The `number of followers` of users in Mozambique  on `2024/2/12 8:13 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
