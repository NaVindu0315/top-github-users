...
The `number of followers` of users in Mozambique  on `2024/4/4 6:16 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
