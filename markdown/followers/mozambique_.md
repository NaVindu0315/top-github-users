...
The `number of followers` of users in Mozambique  on `2024/1/26 2:13 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.
