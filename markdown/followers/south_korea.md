...
The `number of followers` of users in South Korea on `2024/3/2 10:14 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
