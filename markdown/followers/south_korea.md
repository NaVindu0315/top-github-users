...
The `number of followers` of users in South Korea on `2024/2/25 4:16 PM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.
