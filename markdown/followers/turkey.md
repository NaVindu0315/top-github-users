...
The `number of followers` of users in Turkey on `2024/2/8 7:13 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
