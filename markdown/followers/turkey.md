...
The `number of followers` of users in Turkey on `2024/3/8 4:15 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
