...
The `number of followers` of users in El Salvador on `2024/4/8 5:14 PM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.
