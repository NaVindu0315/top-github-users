...
The `number of followers` of users in El Salvador on `2024/4/2 11:14 PM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.
