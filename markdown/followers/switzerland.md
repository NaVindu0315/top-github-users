...
The `number of followers` of users in Switzerland on `2024/2/25 9:14 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
