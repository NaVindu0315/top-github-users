...
The `number of followers` of users in Cyprus on `2024/4/2 5:13 PM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.
