...
The `number of followers` of users in Pakistan on `2024/3/24 4:15 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
