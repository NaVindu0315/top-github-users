...
The `number of followers` of users in Pakistan on `2024/2/1 6:16 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.
