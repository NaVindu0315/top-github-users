...
The `number of followers` of users in Ecuador on `2024/1/13 5:14 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
