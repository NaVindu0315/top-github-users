...
The `number of followers` of users in Finland on `2024/3/22 2:15 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
