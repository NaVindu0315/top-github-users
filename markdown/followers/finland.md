...
The `number of followers` of users in Finland on `2024/2/22 4:17 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
