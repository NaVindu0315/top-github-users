...
The `number of followers` of users in Finland on `2024/4/8 8:16 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
