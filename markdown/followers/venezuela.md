...
The `number of followers` of users in Venezuela on `2024/4/6 7:12 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
