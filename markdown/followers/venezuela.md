...
The `number of followers` of users in Venezuela on `2024/1/22 9:14 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
