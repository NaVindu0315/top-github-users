...
The `number of followers` of users in Venezuela on `2024/3/20 1:15 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
