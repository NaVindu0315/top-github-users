...
The `number of followers` of users in Venezuela on `2024/1/28 3:11 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
