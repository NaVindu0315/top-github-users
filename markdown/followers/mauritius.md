...
The `number of followers` of users in Mauritius on `2024/4/4 12:19 PM UTC`. This list contains users from `Mauritius` and cities `Port-louis` `Curepipe` `Vacoas-phoenix` `Beau-bassin-rose-hill`.
