...
The `number of followers` of users in Jordan on `2024/3/11 8:16 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
