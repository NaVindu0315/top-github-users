...
The `number of followers` of users in Slovenia on `2024/3/19 5:15 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
