...
The `number of followers` of users in Slovenia on `2024/4/5 11:15 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
