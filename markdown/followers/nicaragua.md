...
The `number of followers` of users in Nicaragua on `2024/2/24 3:12 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
