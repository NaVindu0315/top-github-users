...
The `number of followers` of users in Nicaragua on `2024/1/26 8:14 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
