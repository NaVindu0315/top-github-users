...
The `number of followers` of users in Nicaragua on `2024/2/13 2:20 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
