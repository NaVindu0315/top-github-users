...
The `number of followers` of users in Peru on `2024/4/5 8:18 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
