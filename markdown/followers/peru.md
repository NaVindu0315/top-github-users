...
The `number of followers` of users in Peru on `2024/2/7 4:16 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.
