...
The `number of followers` of users in United States on `2024/2/20 12:21 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.
